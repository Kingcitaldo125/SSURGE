...
void ssurge::AnimationBlender::init(const std::string &animation, bool l)
{
...
void ssurge::AnimationBlender::blend(const std::string &animation, BlendingTransition transition, Ogre::Real duration, bool l)
{
	loop = l;
...
void ssurge::AnimationBlender::addTime(Ogre::Real time)
{
	if (mSource != 0)
	{
		if (mTimeleft > 0)
...
ssurge::AnimationBlender::AnimationBlender(Ogre::Entity *entity) : mEntity(entity)
{
}